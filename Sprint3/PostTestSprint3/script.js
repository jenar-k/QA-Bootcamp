...
// ===== BUTTON SATU =====
// Button ini digunakan untuk merubah warna background semua paragraph (p, p1, p2, p3)
...
function satuBalik() {
    const paragraph = document.getElementsByTagName('p');
    for (let i=0; i < 4; i++){
        paragraph[i].style.background = 'white';
    }
}
...
// ===== BUTTON TIGA =====
// Button ini digunakan untuk merubah font-family dan warna text semua paragraph (p, p1, p2, p3)
...
// ===== BUTTON EMPAT =====
// Button ini digunakan untuk merubah font-size semua paragraph (p, p1, p2, p3)
...
tombolButtonSepuluh.addEventListener('click',function(){
    ...
    a.setAttribute('href','https://github.com/jenar-k/QA-Bootcamp/tree/main/Sprint2/PostTestSprint3');
